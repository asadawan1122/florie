...
const ProjectsScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    const projectsArray = data.companyProjects
                                    ...
                                    <View>
                                        <View style={[appStyle.row, appStyle.jcSpaceBetween, appStyle.p15]}>
                                            <View style={appStyle.flex1}>
                                                ...
                                                <H3 style={appStyle.pt5}>{data?.projectName}</H3>
                                            </View>
                                            <View>
                                                <ProgressCircle
                                                    ...
                                                    shadowColor={ColorSet.purpleLight}
                                                    bgColor="#fff"
                                                >
                                                    <View style={[appStyle.ph5, appStyle.aiCenter]}>
                                                        <Paragraph style={{ ...Fonts.size.xmini, textAlign: 'center', fontFamily: FamilySet.bold }}>Completion</Paragraph>
                                                        <H4 style={{ color: ColorSet.purple }}>{data?.percentComplete}</H4>
                                                    </View>
                                        ...
                                        <Accordion
                                            label={
                                                <View style={[appStyle.row, appStyle.aiCenter, appStyle.pl15]}>
                                                    ...
                                                    <Paragraph style={appStyle.pl5}>{data?.startDate}</Paragraph>
                                                </View>
                                            }
                                        >
                                            <View style={[appStyle.dividerTop, appStyle.mt10, appStyle.ph15]}>
                                                <View style={[appStyle.rowBtw, appStyle.pt10]}>
                                                    <View style={appStyle.flex1}>
                                                        <H5>Start Date</H5>
                                                        <H5 style={appStyle.cardDescText}>{data?.startDate}</H5>
                                                    </View>
                                                    <View style={[appStyle.flex1, appStyle.aiFlexEnd]}>
                                                        <H5>Finish Date</H5>
                                                        <H5 style={appStyle.cardDescText}>{data?.finishDate}</H5>
                                                    </View>
                                                </View>
                                                <View style={[appStyle.rowBtw, appStyle.pt10]}>
                                                    <View style={appStyle.flex1}>
                                                        <H5>Cost</H5>
                                                        <H5 style={appStyle.cardDescText}>{data?.cost}</H5>
                                                    </View>
                                                </View>
                                            </View>
                                        </Accordion>
